...
Usage:
    python scripts/train_eit.py --model Qwen/Qwen3-8B --output_dir ./output/qwen3_sparsekv
    python scripts/train_eit.py --model meta-llama/Llama-3.1-8B-Instruct --output_dir ./output/llama_sparsekv
"""
...
class TextDataset(Dataset):
    """Tokenizes text samples to fixed length."""
    
    def __init__(self, tokenizer, dataset_name, subset, split, max_seq_len, num_samples):
        logger.info(f"Loading {num_samples} samples from {dataset_name}/{subset}")
